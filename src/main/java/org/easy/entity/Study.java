...
public class Study implements Serializable {
    ...
    public String toString() {
        return String
                .format("Study[pkTBLStudyID=%d, studyID=%s, studyDescription=%s, studyInstanceUID=%s, accessionNumber=%s, studyDateTime=%s, referringPhysicianName=%s, additionalPatientHistory=%s, admittingDiagnosesDescription=%s, studyStatusID=%s, studyPriorityID=%s, createdDate=%s, modifiedDate=%s, pkTBLPatientID=%s]",
                        pkTBLStudyID, studyID, studyDescription, studyInstanceUID, accessionNumber, studyDateTime, referringPhysicianName,
                        additionalPatientHistory, admittingDiagnosesDescription, studyStatusID, studyPriorityID, createdDate, modifiedDate,
                        patient.getPkTBLPatientID());
    }
