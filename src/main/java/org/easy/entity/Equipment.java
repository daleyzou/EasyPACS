...
public class Equipment implements Serializable {
    ...
    public String toString() {
        return String
                .format("Equipment[pkTBLEquipmentID=%d, modality=%s, conversionType=%s, stationName=%s, institutionName=%s, institutionAddress=%s, institutionalDepartmentName=%s, manufacturer=%s, manufacturerModelName=%s, softwareVersion=%s, deviceSerialNumber=%s, createdDate=%s, modifiedDate=%s]",
                        pkTBLEquipmentID, modality, conversionType, stationName, institutionName, institutionAddress,
                        institutionalDepartmentName, manufacturer, manufacturerModelName, softwareVersion, deviceSerialNumber, createdDate,
                        modifiedDate);
    }
